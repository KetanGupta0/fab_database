...
{
    public function loadAllChatsFromAdmin(Request $request){    // Under Development Phase
        $uid = $request->uid;
        $msgs = AdminChat::get();
        $chats = array();
        foreach($msgs as $msg){
    ...
    public function messageSendToAdmin(Request $request){       // Under Testing Phase
        $uid = $request->uid;
        $msg = $request->msg;
    ...
    public function adminChatSeenFlagChange(Request $request){       // Under Development Phase
